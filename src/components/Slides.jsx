...
function Slides({ data, slideID, onSlideChange }) {
    ...
    switch (SlideActual.slideTemplate) {
        case 'cover':
            return (
                <div className="slide slide__cover" onClick={handleLinkClick} data-nextid={SlideActual.nextId}>
        ...
        case 'index':
            return (
                <div className="slide slide__index">
                    <ul>
        ...
        case 'Text':
            return (
                <div className="slide slide__text" onClick={handleLinkClick} data-nextid={SlideActual.nextId}>
